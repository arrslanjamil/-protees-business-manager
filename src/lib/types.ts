...
export type GrandAdvance = Database['public']['Tables']['grand_advances']['Row']
export type GrandAdvanceRecovery = Database['public']['Tables']['grand_advance_recoveries']['Row']
